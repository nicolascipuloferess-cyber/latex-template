% Set document to 10pt Times New Roman on letter paper
...
% Use 1-inch margins on all sides per JSR guidelines
\geometry{%
  left=1in,%
  right=1in,%
  top=1in,%
...
% Set paragraph spacing and remove indent
\setlength{\parskip}{6pt}
\setlength{\parindent}{0pt}
% Single spacing per JSR guidelines
\singlespacing

% Title of the paper (bolded).  Use 18pt bold font per JSR guidelines.
\title{\fontsize{18}{22}\selectfont\textbf{The Correlation Between SELIC Interest Rate and Real‑Estate Sales in Campinas}}
% Author name and affiliation with contact email
...
% ---------------------------------------------------
% Abstract (Summary) per JSR guidelines
% The abstract should be a single paragraph under 250 words.
\begin{abstract}
...
% Define heading styles to match JSR guidelines
\usepackage{titlesec}
...
\titleformat{\subsubsection}{\itshape\fontsize{12}{14}\selectfont}{\thesubsubsection.\ }{0.5em}{}
\titleformat{\paragraph}{\underline{\fontsize{10}{12}\selectfont}}{\theparagraph.\ }{0.5em}{}
